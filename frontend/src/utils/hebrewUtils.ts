...
export const getUIText = (key: string): string => {
  const translations: Record<string, string> = {
    ...
    'idle': 'פנוי',
    'recent_batch_jobs': 'משרות עיבוד מרוכז אחרונות',
    'no_batch_jobs': 'אין משרות עיבוד מרוכז',
    'no_batch_jobs_description': 'התחל על ידי יצירת משרת עיבוד מרוכז חדשה',
    'job_name': 'שם משרה',
    'progress': 'התקדמות',
    'started': 'התחיל',
    'failed_files': 'קבצים שנכשלו',
    'active_jobs_count': 'משרות פעילות',
    
    // Folder Management
    'folder_management': 'ניהול תיקיות',
    'folder_management_description': 'הגדר ונהל תיקיות חיצוניות לעיבוד מרוכז',
    'add_folder': 'הוסף תיקייה',
    'no_folders_configured': 'אין תיקיות מוגדרות',
    'no_folders_description': 'התחל על ידי הוספת התיקייה החיצונית הראשונה שלך',
    'storage': 'אחסון',
    'monitor': 'ניטור',
    ...
    'folder_test_passed': 'בדיקת תיקייה עברה בהצלחה',
    'folder_test_failed': 'בדיקת תיקייה נכשלה',
    'edit_folder_title': 'ערוך תיקייה',
    'add_new_folder_title': 'הוסף תיקייה חדשה',
    ...
    'batch_job_completed': 'משרת עיבוד מרוכז הושלמה',
    'batch_job_failed': 'משרת עיבוד מרוכז נכשלה',
